...
`;
  ...
  sketch.draw = function() {
      ...
      let noctavesBass = sketch.map(bass, bassEnergyRange.low, bassEnergyRange.high, 1, 6, true);
      ...
      test.setUniform("noctaves", sketch.int(noctavesBass));
      // test.setUniform("noctaves", 4);
